...
/**
 * Fix bugs with StaticBugFixer when the bug positions at the file level is
 * provided.
 *
 * @author kui.liu
 *
...
public class File_Fixer extends Avatar {
    ...
    public File_Fixer(String path, String projectName, int bugId, String defects4jPath, String pm, String pt, String pf) {
        super(path, projectName, bugId, defects4jPath, pm, pt, pf);
    }

    public File_Fixer(String path, String metric, String projectName, int bugId, String defects4jPath, String pm, String pt, String pf) {
    ...
    public void fixProcess() {
        ...
        for (SuspiciousPosition suspiciousCode : suspiciousCodeList) {
            ...
            if (!buggyFileList.contains(suspiciousCode.classPath)) {
                continue;
            }
