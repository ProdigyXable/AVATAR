...
/**
 * Fix bugs with StaticBugFixer when the bug positions at the line level is
 * provided.
 *
 * @author kui.liu
 *
...
public class Line_Fixer extends Avatar {
    ...
    public Line_Fixer(String path, String projectName, int bugId, String defects4jPath, String pm, String pt, String pf) {
        super(path, projectName, bugId, defects4jPath, pm, pt, pf);
    }

    public Line_Fixer(String path, String metric, String projectName, int bugId, String defects4jPath, String pm, String pt, String pf) {
