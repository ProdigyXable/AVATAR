...
public class FL {
    ...
    /**
     * Input: 1. Defects4J project path. e.g., ../Defects4JData/ 2. Output path:
     * e.g., suspiciousCodePositions/ 3. The project name: e.g., Chart_1
     *
     * Output: 1. a ranked list of suspicious statements for a buggy project.
     *
     * @param args
     */
