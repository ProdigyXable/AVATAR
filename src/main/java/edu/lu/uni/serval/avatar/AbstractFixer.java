...
//      }
    ...
    public void saveGeneralSbfl() {
        ...
        File f = new File("ProFL-Avatar" + File.separator + this.buggyProject + File.separator + "generalSusInfo.profl");
    ...
    public void saveProflRanking() {
        ...
        File f = new File("ProFL-Avatar" + File.separator + this.buggyProject + File.separator + "aggregatedSusInfo.profl");
