...
public class Avatar extends AbstractFixer {
    ...
    public Avatar(String path, String projectName, int bugId, String defects4jPath, String pm, String pt, String pf) {
        super(path, projectName, bugId, defects4jPath, pm, pt, pf);
    }

    public Avatar(String path, String metric, String projectName, int bugId, String defects4jPath, String pm, String pt, String pf) {
...
//			log.debug(scn.suspCodeStr);
            ...
            log.debug(String.format("--- Attempting to mutate %s:%d ---", scn.suspiciousJavaFile, scn.buggyLine));
    ...
    private List<Integer> readAllNodeTypes(ITree suspCodeAstNode) {
        ...
        for (ITree child : children) {
            if (Checker.isFieldDeclaration(child.getType())
                    ...
                    || Checker.isStatement(child.getType())) {
                break;
            }
