...
//      }
    ...
    private void saveProflInfo() {
        this.writeListToFile(this.proflRanking.outputSbflSus(), new File(String.format("avatar-output/%s/generalSusInfo.profl", this.buggyProject)));
        this.writeListToFile(this.proflRanking.outputProflResults(), new File(String.format("avatar-output/%s/aggregatedSusInfo.profl", this.buggyProject)));
        this.writeListToFile(this.proflRanking.outputProflCatInfo(), new File(String.format("avatar-output/%s/category_information.profl", this.buggyProject)));
    }
    ...
    private void savePatchInfo(Patch patch, String qualifiedName, String mutatedMethod, SuspCodeNode scn) {
        ...
        this.writeListToFile(messages, new File(String.format("avatar-output/%s/patches/%d.patch", this.buggyProject, this.patchAttempts)));
    }
    ...
    private void saveTestInfo(Set<String> ff, Set<String> fp, Set<String> pf, String qualifiedName, String mutatedMethod, PatchCategory pc) {
        ...
        this.writeListToFile(messages, new File(String.format("avatar-output/%s/tests/%d.tests", this.buggyProject, this.patchAttempts)));
    }
