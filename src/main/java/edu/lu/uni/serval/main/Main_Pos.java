...
//			Configuration.outputPath += "File/";
    ...
    public static void fixBug(String buggyProjectsPath, String defects4jPath, String buggyProjectName, String pm, String pt, String pf) {
        ...
        switch (granularity) {
            case Line:
                fixer = new Line_Fixer(buggyProjectsPath, projectName, bugId, defects4jPath, pm, pt, pf);
                break;
            case Method:
                fixer = new Method_Fixer(buggyProjectsPath, projectName, bugId, defects4jPath, pm, pt, pf);
                break;
            case File:
                fixer = new File_Fixer(buggyProjectsPath, projectName, bugId, defects4jPath, pm, pt, pf);
                break;
            default:
                break;
        }
